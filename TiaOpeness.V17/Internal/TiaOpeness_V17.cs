    ...
    class TiaOpeness_V17 : ITiaOpeness
    {
        ...
        public bool OpenProject(string filePath)
        {
            if (!IsValidProjectFile(filePath))
                throw new FileNotFoundException($"File '{filePath}' is not a valid project file for TIA Portal V17");
        ...
        public bool OpenArchivedProject(string filePath, string destinationDir)
        {
            if (!IsValidProjectArchive(filePath))
                throw new FileNotFoundException($"File '{filePath}' is not a valid project archive for TIA Portal V17");
