...
{
    static class TiaOpenessApiResolver_V21
    {
        ...
        public static Assembly AssemblyResolver(object sender, ResolveEventArgs args)
        {
            ...
            if (lookupName.Name.Equals(TiaOpenessHelper_V21.LibraryKey, StringComparison.OrdinalIgnoreCase))
            {
                var libraryFilePath = TiaOpenessHelper_V21.GetLibraryFilePath();
