...
namespace PlcSimAdvanced.V8_0.Model
{
    public class PlcSimInstanceV80 : IPlcSimInstance
    {
        private static IApplicationLogger logger = Context.Get<IApplicationLogger>();

        public static PlcSimInstanceV80 RetrievePlcInstance(uint index)
        {
            ...
            PlcSimInstanceV80 plc = new PlcSimInstanceV80(instanceName);
        ...
        public static PlcSimInstanceV80 RetrievePlcInstance(string name)
        {
            if (!SimulationRuntimeManager.IsInitialized)
                throw new ArgumentNullException("SimulationRuntimeManager not initialized");
            if ((SimulationRuntimeManager.RegisteredInstanceInfo == null) || (SimulationRuntimeManager.RegisteredInstanceInfo.Length == 0))
            ...
            PlcSimInstanceV80 plc = new PlcSimInstanceV80(name);
        ...
        public static PlcSimInstanceV80 CreatePlcInstance(string name, uint timeout = 0)
        {
            if (!SimulationRuntimeManager.IsInitialized)
        ...
        private PlcSimInstanceV80(string instanceName)
        {
